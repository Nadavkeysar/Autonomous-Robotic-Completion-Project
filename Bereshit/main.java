...
public class main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //Bereshit.PID anglePID = new Bereshit.PID(1,1,-1,360,0);
        ...
        if (bereshit.getVerticalSpeed() < 2.5 && bereshit.getHorizontalSpeed() < 2.5 && bereshit.getAltitude() <= 0) {
