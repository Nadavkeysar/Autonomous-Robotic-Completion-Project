...
public class Ship {
    ...
    public void updateAcceleration() {
        ...
        double ang_rad = Math.toRadians(this.pitch);
        //System.out.println("ido: " + (power*Math.cos(ang_rad) - weightInMoon) / weightKG + ", boaz: " + (((power*Math.cos(ang_rad)/* - weightInMoon*/) / weightKG) - Bereshit.Moon.getAcc(horizontalSpeed)));
